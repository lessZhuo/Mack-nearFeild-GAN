...
class AttentionGANModel():
    ...
    def __init__(self, opt, input_nc, output_nc, ngf, ndf, norm_type='instance', pool_size=50):
        super(AttentionGANModel, self).__init__()
        # specify the training losses you want to print out. The training/test scripts will call <BaseModel.get_current_losses>
        self.loss_names = ['D_A', 'G_A', 'cycle_A', 'idt_A', 'D_B', 'G_B', 'cycle_B', 'idt_B']
        # specify the images you want to save/display. The training/test scripts will call <BaseModel.get_current_visuals>
        visual_names_A = ['real_A', 'fake_B', 'rec_A', 'o1_b', 'o2_b', 'o3_b', 'o4_b', 'o5_b', 'o6_b', 'o7_b', 'o8_b',
                          'o9_b', 'o10_b',
                          'a1_b', 'a2_b', 'a3_b', 'a4_b', 'a5_b', 'a6_b', 'a7_b', 'a8_b', 'a9_b', 'a10_b', 'i1_b',
                          'i2_b', 'i3_b', 'i4_b', 'i5_b',
                          'i6_b', 'i7_b', 'i8_b', 'i9_b']
        visual_names_B = ['real_B', 'fake_A', 'rec_B', 'o1_a', 'o2_a', 'o3_a', 'o4_a', 'o5_a', 'o6_a', 'o7_a', 'o8_a',
                          'o9_a', 'o10_a',
                          'a1_a', 'a2_a', 'a3_a', 'a4_a', 'a5_a', 'a6_a', 'a7_a', 'a8_a', 'a9_a', 'a10_a', 'i1_a',
                          'i2_a', 'i3_a', 'i4_a', 'i5_a',
                          'i6_a', 'i7_a', 'i8_a', 'i9_a']
        ...
        self.netG_A = ResnetGenerator_Attention(input_nc, output_nc, ngf, n_blocks=9)
        self.netG_B = ResnetGenerator_Attention(input_nc, output_nc, ngf, n_blocks=9)
        ...
        if self.isTrain:  # define discriminators
            self.netD_A = NLayerDiscriminator(input_nc, ndf, n_layers=3, norm_layer=norm_layer)
    ...
    def backward_G(self):
        ...
        # Identity loss ___________________取消——————————————————————————————————
        if lambda_idt > 0:
